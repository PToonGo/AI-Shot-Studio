...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#333333] text-[#E4E6EB] font-sans antialiased overflow-x-clip">
      ...
      {/* 1. HEADER SECTION */}
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#333333]/50 backdrop-blur-xl" id="main-studio-header">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-[30px] flex items-center justify-between gap-4 relative">
          ...
          <div className="hidden md:flex bg-[#202020]/95 border border-white/5 rounded-xl overflow-hidden p-[3px] items-center shrink-0">
            <button
        ...
        <div className="border-t border-white/10 bg-[#202020]/85 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-center gap-2 sm:gap-6 md:gap-10">
            <button
              onClick={() => {
                const el = document.getElementById('camera-movements-section');
                if (el) el.scrollIntoView({ behavior: 'smooth' });
              }}
              className="flex items-center gap-1.5 sm:gap-2.5 text-[11px] sm:text-xs font-bold text-gray-400 hover:text-white hover:bg-white/5 active:bg-white/10 px-2.5 sm:px-4 py-1.5 rounded-lg transition-all tracking-wider uppercase cursor-pointer group"
            >
              <Compass className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-purple-400 group-hover:scale-110 group-hover:rotate-12 transition-transform" />
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2.5 text-[11px] sm:text-xs font-bold text-gray-400 hover:text-white hover:bg-white/5 active:bg-white/10 px-2.5 sm:px-4 py-1.5 rounded-lg transition-all tracking-wider uppercase cursor-pointer group"
            >
              <Sparkles className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-indigo-400 group-hover:scale-110 group-hover:rotate-12 transition-transform" />
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2.5 text-[11px] sm:text-xs font-bold text-gray-400 hover:text-white hover:bg-white/5 active:bg-white/10 px-2.5 sm:px-4 py-1.5 rounded-lg transition-all tracking-wider uppercase cursor-pointer group"
            >
              <GraduationCap className="w-4 sm:w-4.5 h-4 sm:h-4.5 text-blue-400 group-hover:scale-110 transition-transform" />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/5 pb-6 scroll-mt-28" id="camera-movements-section">
          ...
          <div className="flex items-center gap-2 bg-[#202020] border border-white/5 rounded-lg px-3 py-1.5 self-start">
        ...
        <div className="space-y-6">
          ...
          <div className="max-w-2xl mx-auto relative group">
            ...
            <input
              ...
              className="w-full bg-[#202020] hover:bg-[#2e2e2e] focus:bg-[#2e2e2e] border border-white/10 focus:border-purple-500 rounded-full py-4 pl-12 pr-6 text-sm text-white placeholder-gray-400 focus:outline-none focus:shadow-[0_0_20px_rgba(168,85,247,0.15)] transition-all"
            />
          </div>
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer ${
                    active 
                      ? 'bg-white text-[#333333] shadow-lg font-bold scale-[1.03]' 
                      : 'bg-[#202020] hover:bg-[#2a2a2a] text-gray-400 hover:text-white border border-white/5'
                  }`}
                >
                  {cat}
                </button>
        ...
        <div className="space-y-6">
          ...
          {filteredMovements.length === 0 ? (
            <div className="text-center py-20 bg-[#202020] border border-white/5 rounded-2xl">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer ${
                    active 
                      ...
                      : 'bg-[#202020] hover:bg-[#2e2e2e] text-gray-400 hover:text-white border border-white/5'
                  }`}
                >
                  {cat}
                </button>
        ...
        <section className="bg-[#202020] border border-white/5 p-6 sm:p-8 mt-12 rounded-2xl relative overflow-hidden flex flex-col lg:flex-row gap-6 lg:items-center justify-between scroll-mt-28" id="learning-hub">
      ...
      <footer className="border-t border-white/5 bg-[#202020] pt-8 pb-[30px] mt-20 relative z-10 select-none">
